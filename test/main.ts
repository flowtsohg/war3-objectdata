...
import { ObjectData, Unit, Units, Item, Items, Destructable, Destructables, Doodad, Doodads, AbilityTypes, Abilities, Buff, Buffs, Upgrade, Upgrades } from "../dist/cjs";
...
const blizzard = <AbilityTypes.Blizzard>objectData.abilities.get(Abilities.Blizzard);
