...
function convertWeu(map, customTriggerData, weTriggerData) {
    ...
    try {
        wtg = (0, parsewtg_1.default)(map, customTriggerData, data);
    }
    catch (e) {
    ...
    for (let i = 0, l = triggers.length; i < l; i++) {
        ...
        try {
            ...
            const result = (0, processing_1.processTrigger)(data, trigger, callbacks);
            // If the trigger itself needs to be converted, convert it.
            if (result.convert) {
                data.push(trigger);
                // The trigger body.
                let body = (0, conversions_1.convertTrigger)(data, trigger, callbacks);
