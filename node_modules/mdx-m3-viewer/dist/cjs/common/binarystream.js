...
class BinaryStream {
    constructor(buffer, byteOffset, byteLength) {
        this.index = 0;
        const bytes = (0, bytesof_1.bytesOf)(buffer);
    ...
    read(bytes) {
        ...
        let end = (0, searches_1.boundIndexOf)(uint8array, 0, start, bytes);
        if (end === -1) {
            end = start + bytes;
        }
        this.index += bytes;
        this.remaining -= bytes;
        return (0, utf8_1.decodeUtf8)(uint8array.subarray(start, end));
    }
    /**
    ...
    readInt8() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = (0, typecast_1.uint8ToInt8)(uint8array[index]);
        this.index += 1;
        this.remaining -= 1;
        return data;
    }
    ...
    readInt16() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = (0, typecast_1.uint8ToInt16)(uint8array[index], uint8array[index + 1]);
        this.index += 2;
        this.remaining -= 2;
        return data;
    }
    ...
    readInt32() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = (0, typecast_1.uint8ToInt32)(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3]);
        this.index += 4;
        this.remaining -= 4;
        return data;
    }
    ...
    readUint16() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = (0, typecast_1.uint8ToUint16)(uint8array[index], uint8array[index + 1]);
        this.index += 2;
        this.remaining -= 2;
        return data;
    }
    ...
    readUint32() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = (0, typecast_1.uint8ToUint32)(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3]);
        this.index += 4;
        this.remaining -= 4;
        return data;
    }
    ...
    readFloat32() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = (0, typecast_1.uint8ToFloat32)(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3]);
        this.index += 4;
        this.remaining -= 4;
        return data;
    }
    ...
    readFloat64() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = (0, typecast_1.uint8ToFloat64)(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3], uint8array[index + 4], uint8array[index + 5], uint8array[index + 6], uint8array[index + 7]);
        this.index += 8;
        this.remaining -= 8;
        return data;
    }
    ...
    readInt8Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            view[i] = (0, typecast_1.uint8ToInt8)(uint8array[index + i]);
        }
    ...
    readInt16Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            ...
            view[i] = (0, typecast_1.uint8ToInt16)(uint8array[offset], uint8array[offset + 1]);
        }
        this.index += view.byteLength;
        this.remaining -= view.byteLength;
        return view;
    ...
    readInt32Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            ...
            view[i] = (0, typecast_1.uint8ToInt32)(uint8array[offset], uint8array[offset + 1], uint8array[offset + 2], uint8array[offset + 3]);
        }
        this.index += view.byteLength;
        this.remaining -= view.byteLength;
        return view;
    ...
    readUint16Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 2;
            view[i] = (0, typecast_1.uint8ToUint16)(uint8array[offset], uint8array[offset + 1]);
        }
        this.index += view.byteLength;
        this.remaining -= view.byteLength;
        return view;
    ...
    readUint32Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 4;
            view[i] = (0, typecast_1.uint8ToUint32)(uint8array[offset], uint8array[offset + 1], uint8array[offset + 2], uint8array[offset + 3]);
        }
        this.index += view.byteLength;
        this.remaining -= view.byteLength;
        return view;
    ...
    readFloat32Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 4;
            view[i] = (0, typecast_1.uint8ToFloat32)(uint8array[offset], uint8array[offset + 1], uint8array[offset + 2], uint8array[offset + 3]);
        }
        this.index += view.byteLength;
        this.remaining -= view.byteLength;
        return view;
    ...
    readFloat64Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            ...
            view[i] = (0, typecast_1.uint8ToFloat64)(uint8array[offset], uint8array[offset + 1], uint8array[offset + 2], uint8array[offset + 3], uint8array[offset + 4], uint8array[offset + 5], uint8array[offset + 6], uint8array[offset + 7]);
        }
        this.index += view.byteLength;
        this.remaining -= view.byteLength;
        return view;
     ...
     */
    write(utf8) {
        const bytes = (0, utf8_1.encodeUtf8)(utf8);
     ...
     */
    writeInt8(value) {
        this.uint8array[this.index] = (0, typecast_1.int8ToUint8)(value);
        this.index += 1;
    }
    /**
    ...
    writeInt16(value) {
        const index = this.index;
        const uint8array = this.uint8array;
        (0, typecast_1.int16ToUint8)(uint8, value);
    ...
    writeInt32(value) {
        const index = this.index;
        const uint8array = this.uint8array;
        (0, typecast_1.int32ToUint8)(uint8, value);
        uint8array[index] = uint8[0];
        uint8array[index + 1] = uint8[1];
    ...
    writeUint16(value) {
        const index = this.index;
        const uint8array = this.uint8array;
        (0, typecast_1.uint16ToUint8)(uint8, value);
        uint8array[index] = uint8[0];
        uint8array[index + 1] = uint8[1];
        this.index += 2;
    }
    ...
    writeUint32(value) {
        const index = this.index;
        const uint8array = this.uint8array;
        (0, typecast_1.uint32ToUint8)(uint8, value);
        uint8array[index] = uint8[0];
        uint8array[index + 1] = uint8[1];
        uint8array[index + 2] = uint8[2];
        uint8array[index + 3] = uint8[3];
    ...
    writeFloat32(value) {
        const index = this.index;
        const uint8array = this.uint8array;
        (0, typecast_1.float32ToUint8)(uint8, value);
        uint8array[index] = uint8[0];
        uint8array[index + 1] = uint8[1];
        uint8array[index + 2] = uint8[2];
        uint8array[index + 3] = uint8[3];
    ...
    writeFloat64(value) {
        const index = this.index;
        const uint8array = this.uint8array;
        (0, typecast_1.float64ToUint8)(uint8, value);
        uint8array[index] = uint8[0];
        uint8array[index + 1] = uint8[1];
        uint8array[index + 2] = uint8[2];
        uint8array[index + 3] = uint8[3];
    ...
    writeInt8Array(view) {
        ...
        const uint8array = this.uint8array;
        for (let i = 0, l = view.length; i < l; i++) {
            uint8array[index + i] = (0, typecast_1.int8ToUint8)(view[i]);
        }
        this.index += view.byteLength;
    }
    /**
    ...
    writeInt16Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 2;
            (0, typecast_1.int16ToUint8)(uint8, view[i]);
    ...
    writeInt32Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 4;
            (0, typecast_1.int32ToUint8)(uint8, view[i]);
            uint8array[offset] = uint8[0];
            uint8array[offset + 1] = uint8[1];
    ...
    writeUint16Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 2;
            (0, typecast_1.uint16ToUint8)(uint8, view[i]);
            uint8array[offset] = uint8[0];
            uint8array[offset + 1] = uint8[1];
        }
        this.index += view.byteLength;
    ...
    writeUint32Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 4;
            (0, typecast_1.uint32ToUint8)(uint8, view[i]);
            uint8array[offset] = uint8[0];
            uint8array[offset + 1] = uint8[1];
            uint8array[offset + 2] = uint8[2];
            uint8array[offset + 3] = uint8[3];
    ...
    writeFloat32Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 4;
            (0, typecast_1.float32ToUint8)(uint8, view[i]);
            uint8array[offset] = uint8[0];
            uint8array[offset + 1] = uint8[1];
            uint8array[offset + 2] = uint8[2];
            uint8array[offset + 3] = uint8[3];
    ...
    writeFloat64Array(view) {
        ...
        for (let i = 0, l = view.length; i < l; i++) {
            const offset = index + i * 8;
            (0, typecast_1.float64ToUint8)(uint8, view[i]);
            uint8array[offset] = uint8[0];
            uint8array[offset + 1] = uint8[1];
            uint8array[offset + 2] = uint8[2];
            uint8array[offset + 3] = uint8[3];
