 ...
 */
class BatchGroup {
    constructor(model, skinningType, isHd) {
        this.objects = [];
        this.model = model;
    ...
    render(instance) {
        ...
        const shader = handler_1.default.getBatchShader(viewer, skinningType, isHd);
        shader.use();
        ...
        if (isHd) {
            ...
            for (const object of this.objects) {
                ...
                if (geosetColor[3] > 0.01 && layerAlpha > 0.01) {
                    ...
                    if (skinningType === batch_1.SkinningType.ExtendedVertexGroups) {
...
exports.default = BatchGroup;
//# sourceMappingURL=batchgroup.js.map