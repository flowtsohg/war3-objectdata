...
class MpqArchive {
    ...
    load(buffer, readonly = false) {
        ...
        const headerOffset = (0, isarchive_1.searchHeader)(bytes);
        if (headerOffset === -1) {
        ...
        const hashPos = (0, typecast_1.numberToUint32)(uint32array[4] + headerOffset); // Whoever thought of MoonLight, clever!
        const blockPos = (0, typecast_1.numberToUint32)(uint32array[5] + headerOffset);
        ...
        for (const hash of this.hashTable.entries) {
            ...
            if (blockIndex < this.blockTable.entries.length) {
                this.files[blockIndex] = new file_1.default(this, hash, this.blockTable.entries[blockIndex], bytes, null);
            }
        }
    ...
    save() {
        ...
        // Write the header.
        uint32array[0] = constants_1.MAGIC;
    ...
    set(name, buffer) {
        ...
        if (file) {
            ...
            file = new file_1.default(this, hash, block, null, bytes);
            file.name = name;
    ...
    get(name) {
        ...
        if (hash) {
            ...
            if (blockIndex < constants_1.HASH_ENTRY_DELETED) {
    ...
    resizeHashtable(size) {
        ...
        size = Math.max(4, (0, math_1.powerOfTwo)(size));
