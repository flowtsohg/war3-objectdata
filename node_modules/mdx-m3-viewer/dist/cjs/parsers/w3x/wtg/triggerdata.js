...
exports.TriggerData = void 0;
const tokenstream_1 = require("../../../utils/jass2/tokenstream");
...
class TriggerData {
    ...
    addTriggerData(buffer, isExternal) {
        ...
        const triggerData = new file_1.IniFile();
    ...
    addTriggerDataFunctions(functions, section, skipped) {
        for (const [key, value] of section) {
            ...
            if (key[0] !== '_') {
                ...
                const scriptName = section.get(`_${key}_scriptname`) || null;
                let returnType = null;
