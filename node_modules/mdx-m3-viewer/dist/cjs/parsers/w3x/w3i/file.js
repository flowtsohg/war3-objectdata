...
class War3MapW3i {
    ...
    getByteLength() {
        let size = 111 + (0, utf8_1.byteLengthUtf8)(this.name) + (0, utf8_1.byteLengthUtf8)(this.author) + (0, utf8_1.byteLengthUtf8)(this.description) + (0, utf8_1.byteLengthUtf8)(this.recommendedPlayers) + (0, utf8_1.byteLengthUtf8)(this.loadingScreenText) + (0, utf8_1.byteLengthUtf8)(this.loadingScreenTitle) + (0, utf8_1.byteLengthUtf8)(this.loadingScreenSubtitle) + (0, utf8_1.byteLengthUtf8)(this.prologueScreenText) + (0, utf8_1.byteLengthUtf8)(this.prologueScreenTitle) + (0, utf8_1.byteLengthUtf8)(this.prologueScreenSubtitle);
        for (const player of this.players) {
        ...
        if (this.version > 24) {
            size += 36 + (0, utf8_1.byteLengthUtf8)(this.loadingScreenModel) + (0, utf8_1.byteLengthUtf8)(this.prologueScreenModel) + (0, utf8_1.byteLengthUtf8)(this.soundEnvironment);
            for (const table of this.randomItemTables) {
                size += table.getByteLength();
            }
        }
