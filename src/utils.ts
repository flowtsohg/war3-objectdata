...
export function saveModificationFile(ModificationsClass: typeof War3MapW3u | typeof War3MapW3d, { original, custom }: { original: ModifiedObject[], custom: ModifiedObject[] }): War3MapW3u | War3MapW3d | undefined {
