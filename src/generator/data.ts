...
export async function loadData(locale: 'enus'): Promise<GeneratorInput> {
  ...
  weStringTable.load(readFile(`_locales/${locale}.w3mod/ui/worldeditstrings.txt`));
  weStringTable.load(readFile(`_locales/${locale}.w3mod/ui/worldeditgamestrings.txt`));
  ...
  profile.load(readFile(`_locales/${locale}.w3mod/ui/worldeditgamestrings.txt`));
  ...
  profile.load(readFile(`_locales/${locale}.w3mod/units/undeadunitstrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/nightelfunitstrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/neutralunitstrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/campaignunitstrings.txt`));
  ...
  profile.load(readFile(`_locales/${locale}.w3mod/units/itemabilitystrings.txt`));
  profile.load(readFile('units/destructableskin.txt'));
  profile.load(readFile(`_locales/${locale}.w3mod/units/destructableskinstrings.txt`));
  profile.load(readFile('doodads/doodadskins.txt'));
  profile.load(readFile(`_locales/${locale}.w3mod/doodads/doodadskinstrings.txt`));
  ...
  profile.load(readFile(`_locales/${locale}.w3mod/units/abilityskinstrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/humanabilitystrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/orcabilitystrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/undeadabilitystrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/nightelfabilitystrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/neutralabilitystrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/commonabilitystrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/campaignabilitystrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/humanupgradestrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/orcupgradestrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/undeadupgradestrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/nightelfupgradestrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/neutralupgradestrings.txt`));
  profile.load(readFile('units/upgradeskin.txt'));
  profile.load(readFile(`_locales/${locale}.w3mod/units/upgradeskinstrings.txt`));
  profile.load(readFile(`_locales/${locale}.w3mod/units/campaignupgradestrings.txt`));
